...
namespace BrokerFacade.Interfaces
{
    ...
    {
        Subscription Subscribe(string topicMatchExpression, IMessageEventHandler handler);
        Subscription Subscribe(string topicMatchExpression, bool durable, IMessageEventHandler handler);
